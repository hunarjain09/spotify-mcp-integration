...
async def sync_song(request: SyncSongRequest) -> SyncSongResponse:
    ...
    Raises:
        HTTPException: If Temporal is not connected or workflow start fails
    """
    ...
    try:
        ...
        logger.info(f"Starting workflow {workflow_id} for {song_metadata}")
...
async def health_check() -> HealthCheckResponse:
    ...
    return HealthCheckResponse(
        status="healthy" if temporal_client is not None else "unhealthy",
